...
class ProcessingPropertiesTest {
	...
	void usesDocumentedDefaultsWhenUnset() {
		ProcessingProperties properties = new ProcessingProperties(null, null, null, null);
	...
	void clampsValuesBelowTheMinimum() {
		ProcessingProperties properties = new ProcessingProperties(0, 0, 0, 0);
	...
	void clampsValuesAboveTheMaximum() {
		ProcessingProperties properties = new ProcessingProperties(10_000, 10_000_000, 999, 999);
